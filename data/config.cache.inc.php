...
$cfg_cmspath = '';
$cfg_cookie_encode = 'LpNRh7860T';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '仙国大帝';
$cfg_webname = 'DEDECMS单本小说源码';
...
$cfg_delete = 'Y';
$cfg_keywords = '';
$cfg_description = '天下之大，惟我正统！以天朝之势横扫天下仙门！ 一个修‘帝王之道’的强者，降临仙门林立的世界，让修行者鄙夷的一个世俗王朝，一步步走到与各大顶级仙门平起平坐。 王朝的法则是，普天之下莫非王土，率土之滨莫非王臣！ 天下正统只有一个，一切仙门，都是非法组织！';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
...
$liebie = '武侠修真';
$zhuangtai = '连载中';
$txtdown = 'http://www.baidu.com/download';
?>